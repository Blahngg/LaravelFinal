<div>
    ...
    <x-messages.success-message class="me-3" on="music-updated">
        {{ __('Music updated successfully!') }}
    </x-messages.success-message>

    <form wire:submit.prevent="update" method="POST" class=" bg-gray-900" enctype="multipart/form-data">
        @csrf
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            <div class="mb-5">
                ...
                <div class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg bg-gray-50  dark:bg-gray-700 dark:border-gray-600 p-4">
                    ...
                    @else
                        <img class="max-h-full max-w-full object-contain" src="{{ asset('storage/' . $musicImage) }}">
                    @endif
                </div>
                @error('image')
                    <p class="mt-2 text-sm text-red-600">
